...
SELECT * FROM scott.emp AS e ,scott.dept AS f
WHERE (e.DEPTNO = 10 AND JOB = 'MANAGER') or (e.DEPTNO = 20 AND JOB = 'SALESMAN') or
      (JOB != 'MANAGER' AND  JOB != 'SALESMAN' AND SAL + ifnull(COMM,0) > 2000);
# 7. 找出获得奖金的员工的工作
